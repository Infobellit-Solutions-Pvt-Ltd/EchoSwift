...
See the README file inside [LLM_Inference_Benchmark (pdf)](Inference-Benchmark-tool-public 2.pdf) for more detailed usage on how to get the dataset and run the becnhmark.
